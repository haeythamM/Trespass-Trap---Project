    ...
    public partial class Form1 : Form
    {
        ...
        private void DataReceve(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                // MessageBox.Show(("Data => " + couter + spl.ReadLine() + "\n"));
                ...
                if (spl.ReadLine() == "0")
                {
                    ...
                    //SecurityBoxInfo.Text = "Reset successfully Confirmed\n";
        ...
        private void button5_Click_2(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //if (flag == false)
                //{
                //    SecurityBoxInfo.Text = "You Have sent \"Snooze Alarm - 2\" to the station";
                //    TimeSnoozeCunt.Start();
                //    if (flg == true)
                //    {
                //        this.btbON.Enabled = false;
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //    btnSnozz.Enabled = true;

            //}
            // lblTime.Text = couter--.ToString();
            //couter--;
            if (couter < 0)
            {
                TimeSnoozeCunt.Stop();
